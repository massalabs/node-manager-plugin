...
// NewNodeManagerPluginAPI creates a new NodeManagerPlugin instance
func NewNodeManagerPluginAPI(spec *loads.Document) *NodeManagerPluginAPI {
	return &NodeManagerPluginAPI{
		...
		StartNodeHandler: StartNodeHandlerFunc(func(params StartNodeParams) middleware.Responder {
			return middleware.NotImplemented("operation StartNode has not yet been implemented")
		}),
		StopNodeHandler: StopNodeHandlerFunc(func(params StopNodeParams) middleware.Responder {
			return middleware.NotImplemented("operation StopNode has not yet been implemented")
		}),
	}
}

/*NodeManagerPluginAPI API for handling local Massa node via Node Manager Plugin in MassaStation */
type NodeManagerPluginAPI struct {
	spec            *loads.Document
	...
	// StopNodeHandler sets the operation handler for the stop node operation
	StopNodeHandler StopNodeHandler
...
func (o *NodeManagerPluginAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *NodeManagerPluginAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *NodeManagerPluginAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *NodeManagerPluginAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *NodeManagerPluginAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *NodeManagerPluginAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *NodeManagerPluginAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *NodeManagerPluginAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *NodeManagerPluginAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the NodeManagerPluginAPI
func (o *NodeManagerPluginAPI) Validate() error {
	...
	if o.StopNodeHandler == nil {
		unregistered = append(unregistered, "StopNodeHandler")
	}
...
func (o *NodeManagerPluginAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *NodeManagerPluginAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	return nil
}

// Authorizer returns the registered authorizer
func (o *NodeManagerPluginAPI) Authorizer() runtime.Authorizer {
	return nil
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *NodeManagerPluginAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *NodeManagerPluginAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *NodeManagerPluginAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the node manager plugin API
func (o *NodeManagerPluginAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *NodeManagerPluginAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/api/start"] = NewStartNode(o.context, o.StartNodeHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/api/stop"] = NewStopNode(o.context, o.StopNodeHandler)
}

// Serve creates a http handler to serve the API over HTTP
// can be used directly in http.ListenAndServe(":8000", api.Serve(nil))
func (o *NodeManagerPluginAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *NodeManagerPluginAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
...
func (o *NodeManagerPluginAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *NodeManagerPluginAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *NodeManagerPluginAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
